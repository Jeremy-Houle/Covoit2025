                ...
                @endif
                 <div class="reservation-status" style="display: flex; align-items: center; gap: 10px;">
                    ...
                    <div class="reservation-actions">
                        @if($isConducteur)
                            <a href="{{ route('messages.show', $resa->IdPassager) }}"
                                class="btn-contact btn btn-sm btn-outline-primary" title="Contacter le passager">
                                <i class="fas fa-envelope"></i> Contacter le passager
                            </a>
                        @else
                            <a href="{{ route('messages.show', $resa->IdConducteur) }}"
                                class="btn-contact btn btn-sm btn-outline-primary" title="Contacter le conducteur">
...
">
                            ...
                            <form action="{{ route('mes-reservations.destroy', $resa->IdReservation) }}" method="POST"
                                class="cancel-form" style="display:inline-block;">
                                @csrf
                                @method('DELETE')
                ...
                <form id="modifyReservationForm" method="POST" action="">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="newPlaces" name="PlacesReservees" min="1"
                                required>
                        </div>
                    </div>
