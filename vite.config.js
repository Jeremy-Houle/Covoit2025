    ...
    plugins: [
        laravel({
            input: [
                ...
                'resources/js/animations/rechercher-animations.js',
                'resources/js/animations/about-animations.js',
                'resources/js/animations/faq-animations.js',
                ...
                'resources/js/animations/reservations-animations.js',
                'resources/js/animations/panier-animations.js',
